    (function ($, undefined) {
      ...
      var repoUrls = {
        "EMS": "http://github.com/lovellfelix/EMS",
      ...
      var repoDescriptions = {
        "EMS": "Employee Management System control Human Resources and personnel management. Advanced features make this application both flexible and easy-to-use!",
      ...
      function addRepos(repos, page) {
        ...
        var uri = "https://api.github.com/users/lovellfelix/repos?callback=?"
                + "&per_page=100"
                + "&page="+page;
      ...
      $.getJSON("https://api.github.com/users/lovellfelix/followers?callback=?", function (result) {
        var followers = result.data;

        $(function () {
          $("#num-followers").text(followers.length);
        });
      });
